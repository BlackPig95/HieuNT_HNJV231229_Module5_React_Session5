...
function ManageEmployee()
{
    ...
    const handleBlock = (employee) =>
    {
        ...
        // setEmployeeInfo(employee); => Page chỉ load lại 1 lần duy nhất?
        setEmployeeInfo({ ...employee }, employee.status = !employee.status);//=>Đúng?
        // setEmployeeInfo({ ...employee, status: !employee.status });//=>Sai?
                        ...
                        <tbody>
                            { employees.map((employee, index) => (
                                <tr>
                                    ...
                                    <td>
                                        <span onClick={ () => handleBlock(employee) } className="button button-block">
